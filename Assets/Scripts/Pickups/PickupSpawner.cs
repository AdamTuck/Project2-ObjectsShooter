...
public class PickupSpawner : MonoBehaviour
{
    ...
    [SerializeField] private float pickupTimeout;
    ...
    public void SpawnPickup(Vector2 position)
    {
        ...
        {
            selectedPickup = pickupPool[Random.Range(0, pickupPool.Count)];

            Pickup spawnedPickup = Instantiate(selectedPickup, position, Quaternion.identity);

            Destroy(spawnedPickup.gameObject, pickupTimeout);
        }
    }
}
